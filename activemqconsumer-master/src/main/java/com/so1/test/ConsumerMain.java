...
public class ConsumerMain {
    ...
    public static void main(String[] args) {
        TestConsumerThread thread01 = new TestConsumerThread("01", 1000);
        TestConsumerThread thread02 = new TestConsumerThread("02", 1000);
        TestConsumerThread thread03 = new TestConsumerThread("03", 1000);
